...
export function ClassCreatePage() {
  ...
  const { result: lecturersResult } = useList<User>({
    resource: RESOURCES.users,
    pagination: { pageSize: 100 },
    filters: [{ field: "role", operator: "eq", value: "lecturer" }],
  });
    ...
    <div className="mx-auto max-w-2xl">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Sections require a subject, a lecturer, and a capacity. The invite
          ...
          <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Select id="lecturer_id" {...register("lecturer_id")}>
                  <option value="">Select a lecturer</option>
                  {lecturersResult?.data.map((lecturer) => (
