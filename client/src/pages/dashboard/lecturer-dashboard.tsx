...
import { CalendarClock, MapPin, School, Users } from "lucide-react";
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          The classes you teach and what's coming up next.
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {classesQuery.isLoading ? "—" : totalCapacity}
            </div>
          </CardContent>
        </Card>
        <Card>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        <section>
          ...
          {classesQuery.isLoading ? (
            ...
            <p className="text-sm text-muted-foreground">
              You're not teaching or tutoring any classes yet.
            </p>
          ) : (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {cls.subject.name} · capacity {cls.capacity}
                    </p>
                  </div>
